...
export const metadata: Metadata = {
  title: "Privacy Policy | FakeID Shield",
  description: "Privacy Policy for FakeID Shield.",
};
    ...
    <>
      ...
      <div className="min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto glass-card p-8 sm:p-12">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-300 mb-8">Last updated: May 06, 2026</p>
          
          <div className="space-y-6 text-gray-700 dark:text-gray-300">
            <p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
            <p>We use Your Personal Data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" rel="noopener noreferrer" className="text-brand-700 dark:text-brand-400 hover:underline">Privacy Policy Generator</a>.</p>
            
            <h2 className="text-2xl font-semibold text-black dark:text-white mt-10 mb-4">Interpretation and Definitions</h2>
            <h3 className="text-xl font-medium text-black dark:text-white mt-6 mb-3">Interpretation</h3>
            <p>The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
            
            <h3 className="text-xl font-medium text-black dark:text-white mt-6 mb-3">Definitions</h3>
            <p>For the purposes of this Privacy Policy:</p>
            <ul className="list-disc pl-6 space-y-4">
              <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
              <li><strong>Affiliate</strong> means an entity that controls, is controlled by, or is under common control with a party, where &quot;control&quot; means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
              <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to authenticchain.</li>
              ...
              <li><strong>Website</strong> refers to authenticchain, accessible from <a href="https://fakeid-analyzer-two.vercel.app/" rel="external nofollow noopener noreferrer" target="_blank" className="text-brand-700 dark:text-brand-400 hover:underline">https://fakeid-analyzer-two.vercel.app/</a>.</li>
              <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
            </ul>

            <h2 className="text-2xl font-semibold text-black dark:text-white mt-10 mb-4">Collecting and Using Your Personal Data</h2>
            <h3 className="text-xl font-medium text-black dark:text-white mt-6 mb-3">Types of Data Collected</h3>
            <h4 className="text-lg font-medium text-black dark:text-white mt-4 mb-2">Personal Data</h4>
            ...
            <h4 className="text-lg font-medium text-black dark:text-white mt-4 mb-2">Usage Data</h4>
            ...
            <h4 className="text-lg font-medium text-black dark:text-white mt-4 mb-2">Tracking Technologies and Cookies</h4>
            ...
            <ul className="list-disc pl-6 space-y-4">
              <li>
                ...
                <p className="mt-1 text-sm">Type: Session Cookies</p>
              ...
              <li>
                ...
                <p className="mt-1 text-sm">Type: Persistent Cookies</p>
                <p className="text-sm">Administered by: Us</p>
            ...
            <h3 className="text-xl font-medium text-black dark:text-white mt-6 mb-3">Use of Your Personal Data</h3>
            ...
            <h3 className="text-xl font-medium text-black dark:text-white mt-6 mb-3">Retention of Your Personal Data</h3>
            ...
            <h3 className="text-xl font-medium text-black dark:text-white mt-6 mb-3">Transfer of Your Personal Data</h3>
            ...
            <h3 className="text-xl font-medium text-black dark:text-white mt-6 mb-3">Delete Your Personal Data</h3>
            ...
            <h3 className="text-xl font-medium text-black dark:text-white mt-6 mb-3">Disclosure of Your Personal Data</h3>
            <h4 className="text-lg font-medium text-black dark:text-white mt-4 mb-2">Business Transactions</h4>
            <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
            <h4 className="text-lg font-medium text-black dark:text-white mt-4 mb-2">Law enforcement</h4>
            <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
            <h4 className="text-lg font-medium text-black dark:text-white mt-4 mb-2">Other legal requirements</h4>
            ...
            <h3 className="text-xl font-medium text-black dark:text-white mt-6 mb-3">Security of Your Personal Data</h3>
            ...
            <h2 className="text-2xl font-semibold text-black dark:text-white mt-10 mb-4">Children&apos;s Privacy</h2>
            ...
            <h2 className="text-2xl font-semibold text-black dark:text-white mt-10 mb-4">Links to Other Websites</h2>
            <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party&apos;s site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
            <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>

            <h2 className="text-2xl font-semibold text-black dark:text-white mt-10 mb-4">Changes to this Privacy Policy</h2>
            <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.</p>
            <p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the &quot;Last updated&quot; date at the top of this Privacy Policy.</p>
            <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>

            <h2 className="text-2xl font-semibold text-black dark:text-white mt-10 mb-4">Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, You can contact us:</p>
            <ul className="list-disc pl-6 space-y-1">
              <li>By email: <a href="mailto:saravanawebdev@gmail.com" className="text-brand-700 dark:text-brand-400 hover:underline">saravanawebdev@gmail.com</a></li>
            </ul>
          </div>
        </div>
      </div>
