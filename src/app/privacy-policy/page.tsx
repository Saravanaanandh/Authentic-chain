    ...
    <>
      ...
      <div className="min-h-screen pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto glass-card p-8 sm:p-12">
          ...
          <p className="text-sm text-slate-400 mb-8">Last updated: May 06, 2026</p>
          
          <div className="space-y-6 text-slate-300">
            <p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
            <p>We use Your Personal Data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" rel="noopener noreferrer" className="text-brand-400 hover:underline">Privacy Policy Generator</a>.</p>
            
            <h2 className="text-2xl font-semibold text-white mt-10 mb-4">Interpretation and Definitions</h2>
            ...
            <ul className="list-disc pl-6 space-y-4">
              ...
              <li><strong>Website</strong> refers to authenticchain, accessible from <a href="https://fakeid-analyzer-two.vercel.app/" rel="external nofollow noopener noreferrer" target="_blank" className="text-brand-400 hover:underline">https://fakeid-analyzer-two.vercel.app/</a>.</li>
              <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
            </ul>

            <h2 className="text-2xl font-semibold text-white mt-10 mb-4">Collecting and Using Your Personal Data</h2>
            ...
            <h4 className="text-lg font-medium text-white mt-4 mb-2">Tracking Technologies and Cookies</h4>
            ...
            <ul className="list-disc pl-6 space-y-4">
              <li>
                Account Information
                <ul className="list-[circle] pl-6 mt-2 space-y-1 text-slate-400">
            ...
            <h3 className="text-xl font-medium text-white mt-6 mb-3">Disclosure of Your Personal Data</h3>
            <h4 className="text-lg font-medium text-white mt-4 mb-2">Business Transactions</h4>
            <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
            <h4 className="text-lg font-medium text-white mt-4 mb-2">Law enforcement</h4>
            <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
            <h4 className="text-lg font-medium text-white mt-4 mb-2">Other legal requirements</h4>
            ...
            <h3 className="text-xl font-medium text-white mt-6 mb-3">Security of Your Personal Data</h3>
            ...
            <h2 className="text-2xl font-semibold text-white mt-10 mb-4">Children&apos;s Privacy</h2>
            ...
            <h2 className="text-2xl font-semibold text-white mt-10 mb-4">Links to Other Websites</h2>
            <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party&apos;s site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
            <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>

            <h2 className="text-2xl font-semibold text-white mt-10 mb-4">Changes to this Privacy Policy</h2>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>By email: <a href="mailto:saravanawebdev@gmail.com" className="text-brand-400 hover:underline">saravanawebdev@gmail.com</a></li>
            </ul>
          </div>
        </div>
      </div>
