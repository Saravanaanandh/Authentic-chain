          ...
          <div className="space-y-6">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="glass-card p-6 sm:p-8">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-10 h-10 rounded-full bg-brand-500/20 flex items-center justify-center text-brand-400 font-bold text-lg border border-brand-500/30">1</div>
                <h2 className="text-xl font-bold text-white">Find a Profile</h2>
              </div>
              <p className="text-slate-400 text-sm mb-4">Navigate to Instagram and copy the URL of the profile you want to verify, or simply note down their exact username.</p>
              <div className="bg-surface-800/50 p-4 rounded-lg border border-surface-600">
                <p className="text-slate-300 font-mono text-sm">Example: <span className="text-brand-300">https://instagram.com/itz__me__saravana18</span></p>
                <p className="text-slate-300 font-mono text-sm mt-2">Or just: <span className="text-brand-300">@itz__me__saravana18</span></p>
              </div>
            </motion.div>

            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="glass-card p-6 sm:p-8">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-10 h-10 rounded-full bg-brand-500/20 flex items-center justify-center text-brand-400 font-bold text-lg border border-brand-500/30">2</div>
                <h2 className="text-xl font-bold text-white">Run the Analysis</h2>
              </div>
              <p className="text-slate-400 text-sm mb-4">Go to our Profile Analyzer page, paste the URL or username into the input box, and click the Analyze button. The AI engine will scrape public data and run multiple risk checks.</p>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="glass-card p-6 sm:p-8">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-10 h-10 rounded-full bg-brand-500/20 flex items-center justify-center text-brand-400 font-bold text-lg border border-brand-500/30">3</div>
                <h2 className="text-xl font-bold text-white">Understand the Results</h2>
              </div>
              <p className="text-slate-400 text-sm mb-6">The system will generate a comprehensive report with a Risk Score, Fake Probability, and a Verdict.</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                <div className="bg-cyber-green/10 border border-cyber-green/30 p-4 rounded-lg text-center">
                  ...
                  <p className="text-xs text-slate-400">Low risk score. Account exhibits normal human behavior.</p>
                </div>
                <div className="bg-cyber-amber/10 border border-cyber-amber/30 p-4 rounded-lg text-center">
                  ...
                  <p className="text-xs text-slate-400">Medium risk. Mixed signals that warrant caution.</p>
                </div>
                <div className="bg-cyber-red/10 border border-cyber-red/30 p-4 rounded-lg text-center">
                  ...
                  <p className="text-xs text-slate-400">High risk. Strong indicators of bot or spam activity.</p>
                </div>
              </div>

              <div className="bg-surface-800/50 p-4 rounded-lg border border-surface-600">
                <h4 className="text-white font-semibold text-sm mb-2 flex items-center gap-2"><FiFileText className="text-brand-400" /> Example Breakdown: @itz__me__saravana18</h4>
